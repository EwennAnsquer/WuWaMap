...
const tpData = [
    ...
    { icon: "/icones/Petite_Balise.png", x: -150.16, y: 66, z: 54 },
    { icon: "/icones/Petite_Balise.png", x: -154.44, y: 97.23, z: 16 },
    { icon: "/icones/Petite_Balise.png", x: -153.34, y: 100.47, z: -179 },
    { icon: "/icones/Petite_Balise.png", x: -156.81, y: 102.11, z: -13 },
    { icon: "/icones/Petite_Balise.png", x: -164.14, y: 51.78, z: 34 },
...
const mobData = [
    ...
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -67.73, y: 87.52, z: 208, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -58.98, y: 86.31, z: 288, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -54.94, y: 86.97, z: 336, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -44.52, y: 94.34, z: 304, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -55.59, y: 113.98, z: 155, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -153.67, y: 60, z: 9, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -182.19, y: 52.16, z: 1, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -207.20, y: 114.88, z: 41, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -196.91, y: 128.55, z: 14, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -197.41, y: 129.5, z: 14, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -199.88, y: 132.42, z: -4, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -190.73, y: 128.48, z: 43, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -183.5, y: 128.98, z: 57, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -187.05, y: 136.47, z: 42, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -193.02, y: 148.14, z: 40, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -205.58, y: 150.77, z: 49, cost: 3 as cost },
    { name: "Héron violet", icon:"/icones/Héron_violet.png", x: -176.11, y: 153.24, z: 64, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -155.81, y: 100.58, z: -40, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -188.19, y: 71.31, z: 53, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -190.33, y: 72.27, z: 50, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -169.05, y: 54.66, z: 1, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -158.02, y: 52.98, z: 1, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -154.95, y: 50.47, z: 2, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -146.59, y: 45.91, z: 25, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -107.72, y: 59.67, z: 69, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -54.86, y: 100.38, z: 208, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -55.34, y: 104.39, z: 238, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -35.63, y: 131.5, z: 7, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -38.03, y: 132.08, z: 1, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -33.63, y: 130.09, z: 2, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -34.77, y: 136.55, z: 3, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -31.27, y: 146.13, z: 2, cost: 3 as cost },
    { name: "Flûtiste", icon:"/icones/Flûtiste.png", x: -24.97, y: 130.34, z: 2, cost: 3 as cost },
];
